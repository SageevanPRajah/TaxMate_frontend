...
const ViewLiabilities = () => {
    ...
    useEffect(() => {
        const fetchLiability = async () => {
            try {
                console.log("Fetching liability with ID:", id);
                const response = await axios.get(`http://localhost:5559/liability/${id}`);
                console.log("Fetched liability:", response.data);
                    ...
                    {loading ? (
                        ...
                        <div className="space-y-6">
                            <div className="p-4 rounded-lg bg-gray-50 shadow-md">
                                ...
                                <p className="text-lg">
                                    <strong className="text-gray-700">Name:</strong> {liability.name}
                                </p>
                                <p className="text-lg">
                                ...
                                <p className="text-lg">
                                    <strong className="text-gray-700">Due Date:</strong> {liability.dueDate}
                                </p>
                            </div>

                            <div className="p-4 rounded-lg bg-gray-50 shadow-md">
                                <h3 className="text-xl font-semibold text-gray-800">Details</h3>
                                <p className="text-lg">{liability.details}</p>
                            </div>
                            ...
                            <div className="flex justify-between mt-6">
                                ...
                                <button
                                    ...
                                    onClick={() => navigate(`/liability/edit/${liability._id}`)}
                                >
                                    Edit Liability
                                </button>
                            </div>
